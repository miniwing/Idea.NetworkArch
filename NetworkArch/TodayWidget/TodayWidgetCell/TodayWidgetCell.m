...
@implementation TodayWidgetCell
...
//   [self.selectedBackgroundView setSize:CGSizeZero];
   ...
   LogDebug((@"-[TodayWidgetCell awakeFromNib] : selectionStyle : %d", self.selectionStyle));
...
//   __TRY;
//
//   LogDebug((@"-[TodayWidgetCell setHighlighted:animated:] : Highlighted : %d", aHighlighted));
//   
//   if (aHighlighted) {
//
//   } /* End if () */
...
//   __TRY;
//
//   LogDebug((@"-[TodayWidgetCell setSelected:animated:] : Selected : %d", aSelected));
//
//   if (aSelected) {
//
//   } /* End if () */
