Pod::Spec.new do |spec|
  spec.name         = "SettingProvider"
  spec.version      = "1.0.0"
  spec.summary      = "SettingProvider"
  spec.description  = "SettingProvider"
  ...
  spec.ios.pod_target_xcconfig      = {
                                        'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.SettingProvider',
                                        'ENABLE_BITCODE'            => 'NO',
                                        'SWIFT_VERSION'             => '5.0',
  ...
  spec.osx.pod_target_xcconfig      = { 'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.SettingProvider' }
  spec.watchos.pod_target_xcconfig  = { 'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.SettingProvider-watchOS' }
  spec.tvos.pod_target_xcconfig     = { 'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.SettingProvider' }
...
#  spec.dependency 'SecurityUtils'
  ...
  spec.public_header_files  = 'SettingProvider/**/*.h'
  spec.source_files         = 'SettingProvider/**/*.{h,hpp,hxx,m,c,cpp,cxx}'
