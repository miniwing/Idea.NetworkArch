Pod::Spec.new do |spec|
  spec.name         = "ImageProvider"
  spec.version      = "1.0.0"
  spec.summary      = "ImageProvider"
  spec.description  = "ImageProvider"
  ...
  spec.ios.pod_target_xcconfig      = {
                                        'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.ImageProvider',
                                        'ENABLE_BITCODE'            => 'NO',
                                        'SWIFT_VERSION'             => '5.0',
  ...
  spec.osx.pod_target_xcconfig      = { 'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.ImageProvider' }
  spec.watchos.pod_target_xcconfig  = { 'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.ImageProvider-watchOS' }
  spec.tvos.pod_target_xcconfig     = { 'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.ImageProvider' }
...
#  spec.dependency 'UserManager'
  ...
  spec.public_header_files  = 'ImageProvider/**/*.h'
  spec.source_files         = 'ImageProvider/**/*.{h,hpp,hxx,m,c,cpp,cxx}'
