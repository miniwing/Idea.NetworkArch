Pod::Spec.new do |spec|
  spec.name         = "PRIVACY"
  spec.version      = "1.0.0"
  spec.summary      = "PRIVACY"
  spec.description  = "PRIVACY"
  ...
  spec.ios.pod_target_xcconfig      = {
                                        'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.PRIVACY',
                                        'ENABLE_BITCODE'            => 'NO',
                                        'SWIFT_VERSION'             => '5.0',
  ...
  spec.osx.pod_target_xcconfig      = { 'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.PRIVACY' }
  spec.watchos.pod_target_xcconfig  = { 'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.PRIVACY-watchOS' }
  spec.tvos.pod_target_xcconfig     = { 'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.PRIVACY' }
...
#  spec.dependency 'IDEANibBridge'
  ...
  spec.resources            = 'PRIVACY/**/*.{xib,storyboard}'
