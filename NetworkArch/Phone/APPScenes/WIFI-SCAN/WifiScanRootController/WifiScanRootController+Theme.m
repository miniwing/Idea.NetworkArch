//
//  WifiScanRootController+Theme.m
//  NetworkArch
//
...
#import "WifiScanRootController+Theme.h"

#pragma mark - UITheme
@implementation WifiScanRootController (Theme)
...
- (void)onThemeUpdate:(NSNotification *)aNotification {
   ...
   LogDebug((@"-[WifiScanRootController+Theme onThemeUpdate:] : Notification : %@", aNotification));
