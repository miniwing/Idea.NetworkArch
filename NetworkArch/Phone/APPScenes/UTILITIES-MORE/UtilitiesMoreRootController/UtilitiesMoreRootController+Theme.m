//
//  UtilitiesMoreRootController+Theme.m
//  NetworkArch
//
...
#import "UtilitiesMoreRootController+Theme.h"

#pragma mark - UITheme
@implementation UtilitiesMoreRootController (Theme)
...
- (void)onThemeUpdate:(NSNotification *)aNotification {
   ...
   LogDebug((@"-[UtilitiesMoreRootController+Theme onThemeUpdate:] : Notification : %@", aNotification));
