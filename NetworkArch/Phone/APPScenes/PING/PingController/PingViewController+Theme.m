...
#import "PingViewController+Theme.h"

#pragma mark - UITheme
@implementation PingViewController+Theme (Theme)
...
- (void)onThemeUpdate:(NSNotification *)aNotification {
   ...
   LogDebug((@"-[PingViewController+Theme onThemeUpdate:] : Notification : %@", aNotification));
