...
//   [self.selectedBackgroundView setSize:CGSizeZero];
   ...
   [self.upLabel setFont:[APPFont lightFontOfSize:self.upLabel.font.pointSize]];
   [self.runingLabel setFont:[APPFont lightFontOfSize:self.runingLabel.font.pointSize]];
   [self.deviceLabel setFont:[APPFont lightFontOfSize:self.deviceLabel.font.pointSize]];

   [self.addressLabel setFont:[APPFont lightFontOfSize:self.addressLabel.font.pointSize]];
   [self.ipLabel setFont:[APPFont lightFontOfSize:self.ipLabel.font.pointSize]];
