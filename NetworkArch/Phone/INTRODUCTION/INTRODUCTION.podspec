Pod::Spec.new do |spec|
  ...
  spec.version      = "1.0.0"
  spec.summary      = "INTRODUCTION"
  spec.description  = "INTRODUCTION"
  ...
  spec.ios.pod_target_xcconfig      = {
                                        'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.INTRODUCTION',
                                        'ENABLE_BITCODE'            => 'NO',
                                        'SWIFT_VERSION'             => '5.0',
  ...
  spec.osx.pod_target_xcconfig      = { 'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.INTRODUCTION' }
  spec.watchos.pod_target_xcconfig  = { 'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.INTRODUCTION-watchOS' }
  spec.tvos.pod_target_xcconfig     = { 'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.INTRODUCTION' }
...
#  spec.dependency 'IDEAPing'
  ...
  spec.public_header_files  = 'INTRODUCTION/Controllers/**/*{Controller,+Notification}.h'
  spec.source_files         = 'INTRODUCTION/**/*.{h,hpp,hxx,m,mm,m++,c,cpp,cxx}'
  
  spec.requires_arc         = true

  spec.resources            = 'INTRODUCTION/**/*.{xib,storyboard}'
