Pod::Spec.new do |spec|
  ...
  spec.version      = "1.0.0"
  spec.summary      = "NetworkService"
  spec.description  = "NetworkService"
  ...
  spec.ios.pod_target_xcconfig      = {
                                        'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.NetworkService',
                                        'ENABLE_BITCODE'            => 'NO',
                                        'SWIFT_VERSION'             => '5.0',
  ...
  spec.osx.pod_target_xcconfig      = { 'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.NetworkService' }
  spec.watchos.pod_target_xcconfig  = { 'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.NetworkService-watchOS' }
  spec.tvos.pod_target_xcconfig     = { 'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.NetworkService' }
...
#                                            "${PODS_ROOT}/Headers/Public/YYKit/"
  ...
  spec.pod_target_xcconfig          = {
    'GCC_PREPROCESSOR_DEFINITIONS'      => [
                                              ...
                                              ' BUNDLE=\"NetworkService\" ',
                                              ' FRAMEWORK_DUPLICATE=0 '
                                            ]
                                      }
...
#  spec.dependency 'ContentProvider'
  ...
  spec.public_header_files  = 'Service/INetworkService.h',
                              'Service/NetworkService.h',
                              'Manager/INetworkManager.h',
                              'Manager/Manager/NetworkManager.h'

  spec.source_files         = 'Service/**/*.{h,hpp,hxx,m,c,cpp,cxx}',
                              'Manager/**/*.{h,hpp,hxx,m,c,cpp,cxx}'
...
//NS_INLINE UIImage * __IMAGE_NAMED_IN_BUNDLE(NSString *aName, NSBundle * aBundle) {
