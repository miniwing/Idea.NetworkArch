...
- (void)setStatistics:(PingStatistics)aPingStatistics value:(NSTimeInterval)aValue {
   ...
   if (PingStatisticsMinmum == aPingStatistics) {
      ...
      [self.titleLabel setText:__LOCALIZED_STRING(self.class, @"Minmum")];
      
   } /* End if () */
   else if (PingStatisticsMaximum == aPingStatistics) {
      
      [self.titleLabel setText:__LOCALIZED_STRING(self.class, @"Maximum")];
      
   } /* End else if () */
   else {

      [self.titleLabel setText:__LOCALIZED_STRING(self.class, @"Average")];
