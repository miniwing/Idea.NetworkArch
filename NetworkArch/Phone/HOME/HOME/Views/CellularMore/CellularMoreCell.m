...
- (void)awakeFromNib {
   ...
   LogDebug((@"-[CellularMoreCell awakeFromNib] : selectionStyle : %d", self.selectionStyle));
   ...
   [self.infoLabel setFont:[UIFont systemFontOfSize:self.infoLabel.font.pointSize weight:UIFontWeightLight]];
...
- (void)setHighlighted:(BOOL)aHighlighted animated:(BOOL)aAnimated {
   ...
   LogDebug((@"-[CellularMoreCell setHighlighted:animated:] : Highlighted : %d", aHighlighted));
...
- (void)setSelected:(BOOL)aSelected animated:(BOOL)aAnimated {
   ...
   LogDebug((@"-[CellularMoreCell setSelected:animated:] : Selected : %d", aSelected));
