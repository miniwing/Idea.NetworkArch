...
- (void)viewDidLoad {
   ...
   [self setTitle:__LOCALIZED_STRING(self.class, @"CELLULAR")];
   LogDebug((@"-[CellularMoreController viewDidLoad] : Title : %@", __LOCALIZED_STRING(self.class, @"CELLULAR")));
   ...
   [self.navigationBarX.navigationBar setTitle:__LOCALIZED_STRING(self.class, @"CELLULAR")];
...
@implementation CellularMoreController (UIStoryboardSegue)
