//
//  LanScanDeviceController+Theme.m
//  NetworkArch
//
...
#import "LanScanDeviceController+Theme.h"

#pragma mark - UITheme
@implementation LanScanDeviceController (Theme)
...
- (void)onThemeUpdate:(NSNotification *)aNotification {
   ...
   LogDebug((@"-[LanScanDeviceController+Theme onThemeUpdate:] : Notification : %@", aNotification));
