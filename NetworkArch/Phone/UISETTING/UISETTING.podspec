Pod::Spec.new do |spec|
  spec.name         = "UISETTING"
  spec.version      = "1.0.0"
  spec.summary      = "UISETTING"
  spec.description  = "UISETTING"
  ...
  spec.ios.pod_target_xcconfig      = {
                                        'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.UISETTING',
                                        'ENABLE_BITCODE'            => 'NO',
                                        'SWIFT_VERSION'             => '5.0',
  ...
  spec.osx.pod_target_xcconfig      = { 'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.UISETTING' }
  spec.watchos.pod_target_xcconfig  = { 'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.UISETTING-watchOS' }
  spec.tvos.pod_target_xcconfig     = { 'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.UISETTING' }
...
#                                            "${PODS_ROOT}/Headers/Public/YYKit/"
  ...
  if ENV['IDEA_EVENT_KIT'] == 'YES'
    spec.dependency 'IDEAEventKit'
  end # IDEA_EVENT_KIT
...
#  spec.dependency 'NetworkService'
  ...
  spec.public_header_files  = 'UISETTING/Controllers/UIAlert/*{Controller,+Notification}.h',
                              'UISETTING/Controllers/UISetting/*{Controller,+Notification}.h',
                              'UISETTING/Controllers/UISetting/UISettingController/*{Controller,+Notification}.h',
                              'UISETTING/Controllers/UIAuthorization/PHAuthorization/*{Controller,+Notification}.h',
                              'UISETTING/Controllers/UIAuthorization/PHAuthorization/PHAuthorizationController/*{Controller,+Notification}.h'
  spec.source_files         = 'UISETTING/**/*.{h,hpp,hxx,m,mm,m++,c,cpp,cxx}'
  
  spec.requires_arc         = true

  spec.resources            = 'UISETTING/**/*.{xib,storyboard}'
