Pod::Spec.new do |spec|
  spec.name         = "MONITOR"
  spec.version      = "1.0.0"
  spec.summary      = "MONITOR"
  spec.description  = "MONITOR"
  ...
  spec.ios.pod_target_xcconfig      = {
                                        'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.MONITOR',
                                        'ENABLE_BITCODE'            => 'NO',
                                        'SWIFT_VERSION'             => '5.0',
  ...
  spec.osx.pod_target_xcconfig      = { 'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.MONITOR' }
  spec.watchos.pod_target_xcconfig  = { 'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.MONITOR-watchOS' }
  spec.tvos.pod_target_xcconfig     = { 'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.MONITOR' }
...
#    pod 'GoogleMobileAdsMediationFacebook'
  ...
  spec.public_header_files  = 'MONITOR/Controllers/**/*{Controller,+Notification}.h'
  spec.source_files         = 'MONITOR/**/*.{h,hpp,hxx,m,mm,m++,c,cpp,cxx}'
  
  spec.requires_arc         = true

  spec.resources            = 'MONITOR/**/*.{xib,storyboard}'
