Pod::Spec.new do |spec|
  spec.name         = "APPDriver"
  spec.version      = "1.0.0"
  spec.summary      = "APPDriver"
  spec.description  = "APPDriver"
  ...
  spec.ios.pod_target_xcconfig      = {
                                        'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.APPDriver',
                                        'ENABLE_BITCODE'            => 'NO',
                                        'SWIFT_VERSION'             => '5.0',
  ...
  spec.osx.pod_target_xcconfig      = { 'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.APPDriver' }
  spec.watchos.pod_target_xcconfig  = { 'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.APPDriver-watchOS' }
  spec.tvos.pod_target_xcconfig     = { 'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.APPDriver' }
...
#                                            "${PODS_ROOT}/Headers/Public/YYKit/"
  ...
  spec.pod_target_xcconfig          = {
    'GCC_PREPROCESSOR_DEFINITIONS'      => [ ' MODULE=\"APPDriver\" ' ]
                                      }
  ...
  spec.dependency 'IDEALanScan'
  spec.dependency 'APPDATA'

  spec.public_header_files  = 'Models/**/*.h',
                              'DATA-USAGE/*.h',
                              'DEVICE-AWAKE/*.h',
                              'DNS/*.h',
                              'WHOIS/*.h'
                              
  spec.source_files         = 'Models/**/*.{h,m}',
                              'DATA-USAGE/*.{h,m}',
                              'DEVICE-AWAKE/*.{h,m}',
                              'DNS/*.{h,m}',
                              'WHOIS/*.{h,m}'
...
#  if __has_include(<SettingProvider/SettingProvider.h>)
#     import <SettingProvider/SettingProvider.h>
#     import <SettingProvider/UISetting.h>
#     define SETTING_PROVIDER                                              (1)
#  elif __has_include("SettingProvider/SettingProvider.h")
#     import "SettingProvider/SettingProvider.h"
#     import "SettingProvider/UISetting.h"
#     define SETTING_PROVIDER                                              (1)
#  else
#     define SETTING_PROVIDER                                              (0)
#  endif
